defmodule RadioappWeb.CoreComponents do
  @moduledoc """
  ...
  attr :rest, :global, include: ~w(disabled form name value formaction)
  ...
  def table(assigns) do
    ~H"""
    <div id={@id} class="px-4 sm:px-0 overflow-x-auto">
      <table class="format-table mt-4 w-[40rem] sm:w-full w-full">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RadioappWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RadioappWeb.Gettext, "errors", msg, opts)
    end
  end
