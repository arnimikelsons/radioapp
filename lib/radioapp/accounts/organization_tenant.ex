defmodule Radioapp.Accounts.OrganizationTenant do
  ...
  # defp create_family(tenant) do 
  #   Referral.create_family(
  #     %{
  #       city_town: "Timbuktu",
  #       confidential_info: "Yep",
  #       family_info: "Joe Worker's family",
  #       no_of_adults: "2",
  #       parent1_first_name: "Alice",
  #       parent1_last_name: "Example",
  #       parent2_first_name: "Bob",
  #       parent2_last_name: "Example",
  #       referral_status: "Draft",
  #       parent_gift: "Something",
  #       familytypes_id: 1,
  #       grocerystores_id: 1,
  #       grocery_store_details: "some grocery store details"
  #     },
  #     tenant
  #   )
  # end
