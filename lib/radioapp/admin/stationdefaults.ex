defmodule Radioapp.Admin.Stationdefaults do
  ...
  def changeset(stationdefaults, attrs) do
    stationdefaults
    |> cast(attrs, [:callsign, :from_email, :from_email_name, :logo_path, :org_name, :timezone, :privacy_policy_url, :support_email, :phone, :playout_url, :playout_type, :tos_url, :website_url, :csv_permission, :intro_email_subject, :intro_email_body, :api_permission, :socan_permission, :export_log_permission, :enable_archives, :program_show])
